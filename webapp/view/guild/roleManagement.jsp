    ...
    <body>
                ...
                <div class="permissions-container">
                    <div class="role-container">
                        <div>
                            ...
                            <select id="role-select" onchange="fetchPermissions()">
                                <%
                    ...
                    <div class="permissions-wrapper">
                        <div class="current-permissions">
                            ...
                            <ul id="current-permissions-list">
                                <%
                                    List<String> currentPermissions = (List<String>) request.getAttribute("currentPermissions");
                        ...
                        <div class="available-permissions">
                            ...
                            <ul id="available-permissions-list">
                                <%
                                List<String> availablePermissions = (List<String>) request.getAttribute("availablePermissions");
                                ...
                                <li><%= permission%></li>
                                    ...
                                    %>
                                <li>No available permissions</li>
                                    <%
                                        }
                                    %>
                        </div>
        ...
        <script>
            function fetchPermissions() {
                ...
                const currentPermissions = rolePermissions[role].current;
                const availablePermissions = rolePermissions[role].available;
