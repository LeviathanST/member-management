...
public class UserRole {
	...
	public static int getIdByAccountId( String account_id) throws SQLException, NotFoundException, IOException, ClassNotFoundException {
	...
	public static void insert(String account_id, int role_id) throws SQLException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
			String query = """
	...
	public static void update( String account_id, int new_role_id) throws SQLException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
			String query = """
				UPDATE user_role
				SET role_id = ?
