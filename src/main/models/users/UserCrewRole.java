...
public class UserCrewRole {
	...
	public static List<UserCrewRoleDto> getAllByCrewId(String crew, int crewId) throws SQLException, IndexOutOfBoundsException, NotFoundException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
			String query = """
