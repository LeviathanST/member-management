...
public class CrewPermission {
	...
	public static List<String> getAllByCrewRoleId( int crewRoleId)
            throws SQLException, NotFoundException, NullPointerException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
	...
	public static void addPermissionToCrewRole( int crewRoleId, int permissionId) throws SQLException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
	...
	public static void updatePermissionInCrewRole(int newPermissionID,int permissionID,int crewRoleId) throws SQLException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
	...
	public static void deletePermissionInCrewRole(int permissionID,int crewRoleId) throws SQLException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
