...
public class GuildEvent {
	// Insert
	public static void insert(GuildEventDto data) throws SQLException, IOException, ClassNotFoundException {
	...
	// Update
	public static void update( GuildEventDto data, int guildEventID) throws SQLException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
			String query = """
				    UPDATE guild_event
	...
	public static List<GuildEventDto> getAllGuildEvent() throws SQLException, NotFoundException, IOException, ClassNotFoundException {
		try(Connection con = Database.connection()) {
			...
			while (rs.next()) {
				guildEvent.add(new
						...
						Guild.getNameByID(rs.getInt("guild_id")),
						rs.getString("title"),
