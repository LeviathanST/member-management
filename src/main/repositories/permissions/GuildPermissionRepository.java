...
public class GuildPermissionRepository {
	...
	public static void addPermissionToGuildRole(int guildRoleId, int permissionId)
			throws SQLException, IOException, ClassNotFoundException {
		try (Connection con = Database.connection()) {
	...
	public static void updatePermissionInGuildRole(int newPermissionID, int permissionID, int guildRoleID)
			throws SQLException, IOException, ClassNotFoundException {
		try (Connection con = Database.connection()) {
	...
	public static void deletePermissionInGuildRole(int permissionID, int guildRoleID)
			throws SQLException, IOException, ClassNotFoundException {
		try (Connection con = Database.connection()) {
