...
public class CrewView extends View {
    ...
    public UserCrewRole getUserCrewRoleFromList(Connection connection) {
        TextIO textIO = TextIoFactory.getTextIO();
        ResponseDTO<List<UserCrewRole>> response;
        String crewName = getCrewFromList(connection);
        ...
        return new UserCrewRole(crewName, parts.get(0), parts.get(1));
    }
    ...
    public int getCrewEventIDFromList(Connection connection) {
        TextIO textIO = TextIoFactory.getTextIO();
        ResponseDTO<List<CrewEvent>> response = CrewController.getAllCrewEvent();
        ...
        for (CrewEvent crewEventDto : response.getData()) {
            crewEvents.put(crewEventDto.getCrewName() + " - " + crewEventDto.getTitle() + " - " + crewEventDto.getType()
                    + " - " + crewEventDto.getGeneration(), crewEventDto.getId());
            crewEventList.add(crewEventDto.getCrewName() + " - " + crewEventDto.getTitle() + " - "
                    + crewEventDto.getType() + " - " + crewEventDto.getGeneration());
        }
        if (response.getStatus() != ResponseStatus.OK) {
            printError(response.getMessage());
        } else {
    ...
    public void viewCreateCrew(Connection connection, ViewCrewCommand option) {
        ...
        do {
            ...
            String crewName = textIO.newStringInputReader()
                    ...
                    .read("");
            Crew crewDTO = new Crew(crewName);
    ...
    public void viewUpdateCrew(Connection connection, ViewCrewCommand option) {
        ...
        do {
            ...
            String newCrew = textIO.newStringInputReader()
                    .withDefaultValue(null)
                    .read("");
            Crew oldCrewDTO = new Crew(crewUpdated);
            Crew newCrewDTO = new Crew(newCrew);
    ...
    public void viewDeleteCrew(Connection connection, ViewCrewCommand option) {
        ...
        do {
            ...
            Crew crewDTO = new Crew(crewDeleted);
    ...
    public void viewAddCrewRole(Connection connection, CrewRoleCommand option) {
        ...
        do {
            ...
            String crewRole = textIO.newStringInputReader()
                    .withDefaultValue(null)
                    .read("");
            CrewRole data = new CrewRole(crewRole, crew);
            response = CrewController.addCrewRole(data);
            if (response.getStatus() != ResponseStatus.OK) {
                printError(response.getMessage());
                waitTime(500);
            } else {
    ...
    public void viewUpdateCrewRole(Connection connection, CrewRoleCommand option) {
        ...
        do {
            ...
            String newCrewRole = textIO.newStringInputReader()
                    .withDefaultValue(null)
                    .read("");
            CrewRole crewRoleDTO = new CrewRole(crew.getSecond(), crew.getFirst());
            CrewRole newCrewRoleDTO = new CrewRole(newCrewRole, crew.getFirst());
    ...
    public void viewAddUserCrewRole(Connection connection, UserCrewRoleCommand option) {
        ...
        do {
            ...
            UserCrewRole userCrewRoleDto = new UserCrewRole(pair.getFirst(), username, pair.getSecond());
    ...
    public void viewUpdateUserCrewRole(Connection connection, UserCrewRoleCommand option) {
        ...
        do {
            TextIO textIO = TextIoFactory.getTextIO();
            viewTitle(option.toString(), textIO);
            UserCrewRole oldUserCrewRole = getUserCrewRoleFromList(connection);
            ...
            UserCrewRole newUserCrewRole = new UserCrewRole(newCrewRole.getFirst(), oldUserCrewRole.getUsername(),
                    newCrewRole.getSecond());
    ...
    public void viewDeleteUserCrewRole(Connection connection, UserCrewRoleCommand option) {
        ...
        do {
            TextIO textIO = TextIoFactory.getTextIO();
            viewTitle(option.toString(), textIO);
            UserCrewRole userCrewRole = getUserCrewRoleFromList(connection);
    ...
    public void viewCrewPermission(Connection connection) {
        ...
        String options = textIO.newStringInputReader()
                .withNumberedPossibleValues("VIEW CREW PERMISSION", "CRUD PERMISSION", "CRUD PERMISSION TO CREW ROLE",
                        "BACK")
                .read("");
        switch (options) {
    ...
    public void viewPermissionByAccountIdAndCrewId(Connection connection, String option) {
        ...
        String username = textIO.newStringInputReader()
                .withDefaultValue(null)
                .read("");
        ResponseDTO<List<CrewPermission>> response = CrewController.getAllPermissionByAccountId(crew, username);
    ...
    public void viewCRUDPermission(Connection connection) {
        ...
        CrewPermissionCommand options = textIO.newEnumInputReader(CrewPermissionCommand.class)
    ...
    public void viewAddPermissionToCrewRole(Connection connection, PermissionOfCrewCommand option) {
        ...
        do {
            ...
            CrewRole crewRole = new CrewRole(crewAndRole.getSecond(), crewAndRole.getFirst());
    ...
    public void viewUpdatePermissionInCrewRole(Connection connection, PermissionOfCrewCommand option) {
        ...
        do {
            ...
            String permissionUpdated = getPermissionByCrewAndRoleFromList(connection, crewAndRole.getFirst(),
                    crewAndRole.getSecond());
    ...
    public void viewDeletePermissionInCrewRole(Connection connection, PermissionOfCrewCommand option) {
        ...
        do {
            ...
            String permissionDeleted = getPermissionByCrewAndRoleFromList(connection, crewAndRole.getFirst(),
                    crewAndRole.getSecond());
            CrewRole crewRole = new CrewRole(crewAndRole.getSecond(), crewAndRole.getFirst());
    ...
    public void viewListCrewEvent(Connection connection, CrewEventCommand option) {
        ResponseDTO<List<CrewEvent>> response;
        ...
        for (CrewEvent crewEvent : response.getData()) {
